    ...
    <div className="stars" style={{ minHeight: '100vh', background: '#080b14', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{ width: '100%', maxWidth: 460, position: 'relative', zIndex: 1 }}>
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <h1 style={{ fontSize: 26, fontWeight: 800, color: '#fff' }}>Welcome back to <span style={{ color: '#10b981' }}>HireMind.AI</span></h1>
          <p style={{ fontSize: 15, color: 'rgba(255,255,255,0.45)', marginTop: 8 }}>Sign in to continue your interview prep</p>
        </div>
